...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseDto<?> makeExceptionResponse(ExceptionCode exceptionCode) {
        return ResponseDto.exception(exceptionCode.getMessage());
    }
    ...
    private ResponseDto<?> makeExceptionResponse(String message) {
        return ResponseDto.exception(message);
    }
}
